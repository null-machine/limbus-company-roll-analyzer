...
A pink square indicates that a unit performs notably well in the context of maximin strategies. They may be an option for Refraction Railway, but require too many resets or too much setup to be practical otherwise. (Shi Ishmael, W Meursault)
...
Emphasis will not be placed on colours— there's no telling what future EGOs hold in store. Furthermore, Refraction Railway 1 has proven that simply taking strong individual identities will outperform a team that goes out of its way to align colours for EGO or resonance. 

Aditionally, damage typing will be ignored in an attempt to maintain future-proofing for unknown encounters.

For the sake of transparency, let it be known that the author is slightly biased towards G Gregor, W Don and L Faust, and slightly biased against R Heath and N Rodion, but everything is still kept as objective as possible.
